...
const MotorData Config_motor[6]={
	{1,RCC_APB1Periph_TIM4,TIM4,{GPIOA,GPIO_Pin_0},{GPIOC,GPIO_Pin_13},{GPIOA,GPIO_Pin_13},{GPIOA,GPIO_Pin_14},{GPIOA,GPIO_Pin_15},{GPIOC,GPIO_Pin_12},},
	{2,RCC_APB1Periph_TIM2,TIM2,{GPIOB,GPIO_Pin_8},{GPIOB,GPIO_Pin_10},{GPIOA,GPIO_Pin_8} ,{GPIOA,GPIO_Pin_9} ,{GPIOC,GPIO_Pin_7} ,{GPIOC,GPIO_Pin_6} ,},
